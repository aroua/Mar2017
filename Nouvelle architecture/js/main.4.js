...
// 	z up 
	...
	var refreshNombreTour = function() {
		numberTourPanel.innerHTML = "nombreTour : " + nombreTour;
	};
	...
	function refreshStart() {
		if (car0.position.y > 50) {
			...
			if (!isPositionBig50) {
				isPositionBig50 = true;
				nombreTour = nombreTour + 1;
			}
		}
		else {
			isPositionBig50 = false;
		}
	}
	...
	var numberTourPanel = document.createElement('div');
	numberTourPanel.style.position = 'absolute';
	numberTourPanel.style.width = 180;
	numberTourPanel.style.height = 20;
	numberTourPanel.style.top = '2px';
	numberTourPanel.style.left = '150px';
	numberTourPanel.style.padding = "8px";
	numberTourPanel.style.backgroundColor = "#555588";
	numberTourPanel.style.color = "#ffaaaa";
	numberTourPanel.style.fontSize = "20px";
	document.body.appendChild(numberTourPanel);
	refreshNombreTour();
